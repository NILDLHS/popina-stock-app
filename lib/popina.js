...
function logSync(popinaSiteId, eventType, webhookId, status, message) {
  db.prepare(`
    ...
    VALUES (?, ?, ?, ?, ?, ?)
  `).run(id('psl'), popinaSiteId, eventType, webhookId || null, status, message || null);
}
...
module.exports = { computeHmac, verifySignature, getPopinaSiteByLocationId, getPopinaSite, logSync, alreadyProcessed, findMapping, handleOrderPaid };
